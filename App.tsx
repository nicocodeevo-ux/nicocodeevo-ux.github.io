                  ...
                  <div className="p-6 apple-glass brushed-metal rounded-[2.5rem] border border-white/5 hover:border-[#ff7a22]/30 transition-all glossy-finish group">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {['Python', 'Django', 'FastAPI', 'PostgreSQL', 'REST APIs', 'Pandas', 'NumPy', 'Testing/Debugging'].map(skill => (
                        <span key={skill} className="px-4 py-2 bg-white/5 rounded-xl font-mono text-[10px] border border-white/10 apple-glass brushed-metal tracking-wider hover:bg-[#ff7a22]/10 transition-colors">{skill}</span>
                      ))}
                    </div>
                    <div className="mt-8 p-4 bg-black/60 rounded-3xl border border-white/5 font-mono text-[11px] text-white/30 shadow-inner group-hover:border-[#ff7a22]/20 transition-all">
